...
import { GithubPage } from "./screens/Auth/Github";
...
export default function App() {
  /**
   * @see
   * if you use 'https://clerk.mint.mackerel-64.lcl.dev'
   * it will fail!
   */
  return (
    <ClerkProvider
      frontendApi="clerk.mint.mackerel-64.lcl.dev"
                  ...
                  <>
                    ...
                    <SignedOut>
                      ...
                      */
                      ...
                      <Text className="text-purple-300">NOT LOGGED! 😮</Text>
                    </SignedOut>
                  </>
                }
              />
